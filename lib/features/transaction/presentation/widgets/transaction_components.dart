...
class _CategoryDialogContentState extends State<CategoryDialogContent> {
  ...
  @override
  Widget build(BuildContext context) {
    final activeList = type == 'Pengeluaran'
        ...
        children: [
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                Color bgColor = isSelected
                    ? primaryBlue
                    : (isLainnya ? Colors.grey[200]! : const Color(0xFFE8F0FE));
                Color iconColor = isSelected
                    ? Colors.white
                    : (isLainnya ? Colors.black54 : primaryBlue);

                return GestureDetector(
                  onTap: () =>
                      setState(() => selected = activeList[index]['name']),
                  child: Column(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () =>
                  selected.isNotEmpty ? Navigator.pop(context, selected) : null,
              style: ElevatedButton.styleFrom(
